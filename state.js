...
export let appState = {
    ...
    entityColors: {},
    visibleColumns: {
        dispatcher: new Map(allColumns.map(c => [c.id, c.defaultVisible])),
        team: new Map(allColumns.map(c => [c.id, c.defaultVisible]))
    },
    ...
    delegation: {
        activeContractFilter: 'ALL', // Dynamic default
    ...
    overdueLoadsData: [],
     ...
     loads: {
        ...
        // This will be populated dynamically from your data in main.js
        contractTypes: [],
