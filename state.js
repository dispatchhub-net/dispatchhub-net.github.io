...
export let appState = {
    ...
    profiles: {
        fleetHealthCache: {},
        liveData: [], // <-- ADD THIS LINE
        liveDriverCountData: [],
        currentTeamData: null,
        selectedTeam: 'SMT',
        isKpiSettingsOpen: false,
        selectedDispatcherId: null,
        contractTypeFilter: 'all', // 'all', 'oo', or 'loo'
        isContractTypeFilterOpen: false, // To manage the dropdown visibility
        selectedCompany: 'All Companies', // Add this line
        isCompanyFilterOpen: false, // Add this line
        selectedWeek: 'live',
        isWeekSelectorOpen: false, // To manage the dropdown visibility
        activeDetails: { 
            dispatcherId: null,
            metricId: null
        },
        ...
        dispatchTable: {
            sortConfig: { key: 'complianceScore', direction: 'ascending' }, // Default sort changed to ascending
            columnOrder: [
            ...
            pinnedRightColumns: ['complianceScore'], // <-- Replace with this line
            draggedColumnId: null,
        },
        driverTable: { // New state for the driver table
            sortConfig: { key: 'risk', direction: 'descending' } // Default sort
        },
        ...
        driverHealthSettings: {
            ...
            isModalOpen: false,
            weights: { // Weights for Drop Risk Calculation
                highTolls: 5,
                dispatcherHopper: 5,
                lowRpm: 15,
                lowGross: 15,
            ...
            flags: {
                highTolls: {
                    ...
                    lookback: { type: 'weeks', value: 8 },
                    thresholds: { default: 30, by_contract: {} },
                    minStubs: 4
                },
                dispatcherHopper: {
                    enabled: true,
                    ...
                    thresholds: { default: 3, by_contract: {} }
                },
                lowRpm: {
                    enabled: true,
                    label: 'Low RPM',
                    ...
                    lookback: { type: 'weeks', value: 10 },
                    thresholds: { default: 1.80, by_contract: {"LOO": 1.75} },
                    minPercentageOfStubs: 40,
                    minStubs: 4
                },
                lowGross: {
                    enabled: true,
                    ...
                    lookback: { type: 'weeks', value: 10 },
                    thresholds: { default: 5000, by_contract: {"LOO": 6000} },
                    minPercentageOfStubs: 50,
                    minStubs: 4
                },
                lowNet: {
                    enabled: true,
                    ...
                    lookback: { type: 'weeks', value: 10 },
                    thresholds: { default: 1000, by_contract: {"OO": 2000} },
                    minPercentageOfStubs: 50,
                    minStubs: 4
                },
                heavyLoads: {
                    ...
                    lookback: { type: 'weeks', value: 10 },
                    thresholds: { default: 40000, by_contract: {} },
                    minLoads: 8
                },
                negative: {
                    enabled: true,
                    ...
                    thresholds: { default: 3000, by_contract: {"OO": 2000} },
                    minStubs: 6
                }
            }
        },
        tempDriverHealthSettings: null, // To hold settings until saved
    },
