...
export const CRITERIA_APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzHpn8Nt5i5Wk2BURZMJuBY7tbiCcF8lb9O8lMlzBk_vnsu7AIfxYmVxX7TNKbJNRml/exec';
...
export const generateAllColumns = () => {
    ...
    const defaultVisibleColumnIds = new Set([
        ...
        'compliance_current', 'compliance_4wkAvg',
