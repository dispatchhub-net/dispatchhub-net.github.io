        ...
        <table class="min-w-full divide-y divide-gray-700">
            <thead class="bg-gray-700 sticky top-0 z-10">
                <tr>
                    ...
                    <th class="px-4 py-2 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Access</th>
            ...
            <tbody class="divide-y divide-gray-800">
                ${allUsers.map(user => `
                    <tr class="hover:bg-gray-700/50">
                        ...
                        <td class="px-4 py-2 text-center">${user.permissions.hasLoadsAccess ? '✅' : '❌'}</td>
                        <td class="px-4 py-2 text-right">
                            <div class="flex justify-end items-center gap-x-2">
                                <button class="toolbar-btn !p-2 edit-user-btn" data-user-id="${user.userId}" title="Edit User">✏️</button>
                                <button class="toolbar-btn !p-2 !bg-red-800 hover:!bg-red-700 delete-user-btn" data-user-id="${user.userId}" title="Delete User">🗑️</button>
                            </div>
                        </td>
                    </tr>
                `).join('')}
