        ...
        <table class="min-w-full divide-y divide-gray-700">
            <thead class="bg-gray-700 sticky top-0 z-10">
                <tr>
                    ...
                    <th class="px-4 py-2 text-center text-xs font-medium text-gray-300 uppercase tracking-wider">Profiles Access</th>
            ...
            <tbody class="divide-y divide-gray-800">
                ${allUsers.map(user => `
                    <tr class="hover:bg-gray-700/50">
                        ...
                        <td class="px-4 py-2 text-center">${user.permissions && user.permissions.hasPerformanceAccess ? '✅' : '❌'}</td>
...
function openUserFormModal(user = null) {
    ...
    if (user) {
        ...
        document.getElementById('user-performance-access-checkbox').checked = user.permissions.hasPerformanceAccess || false;
    ...
    const userData = {
       ...
       role: role,
        ...
        permissions: {
            ...
            hasPerformanceAccess: document.getElementById('user-performance-access-checkbox').checked,
        }
    };
