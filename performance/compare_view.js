    ...
    renderComparisonView: function(d1, d2, uiContext) {
        ...
        const renderCompareMetric = (item1, item2) => {
             ...
             const getVal = (i) => {
                 if (i.bd) {
                     const parts = [];
                     if(i.bd.oo !== undefined && i.bd.oo !== null) parts.push(`<span style="color:#fbbf24;">OO:</span> <span style="color:#fff;">${i.fmt(i.bd.oo)}</span>`);
                     if(i.bd.loo !== undefined && i.bd.loo !== null) parts.push(`<span style="color:#fbbf24;">LOO:</span> <span style="color:#fff;">${i.fmt(i.bd.loo)}</span>`);
