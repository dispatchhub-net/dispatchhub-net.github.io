...
export function load1WkAllView() {
    ...
    const oneWkColumnIds = new Set([
        ...
        'pMainCriteriaNetDriverMargin_current', 'pMainCriteria2CashFlow_current', 'compliance_current', 'mainCriteria_current'
    ]);
...
export function load4WkAllView() {
    ...
    const fourWkColumnIds = new Set([
        ...
        'pMainCriteriaNetDriverMargin_4wkAvg', 'pMainCriteria2CashFlow_4wkAvg', 'compliance_4wkAvg', 'mainCriteria_4wkAvg'
    ]);
    allColumns.forEach(col => {
